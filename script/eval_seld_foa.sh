...
datasets=(
    "TNSSE21  ./data_dcase2021_task3/list_dataset/dcase2021t3_foa_devtest.txt None"
    "STARSS23 ./data_dcase2023_task3/list_dataset/dcase2023t3_foa_devtest.txt None"
)
...
fixed_params=(
    ...
    embaccdoa embaccdoa_pit embaccdoa threshold_pit 0.4 0.6 0.3"
)
